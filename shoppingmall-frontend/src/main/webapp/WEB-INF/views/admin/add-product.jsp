	...
	$(document).ready(function() {
	    ...
	    $("#add-option").click(function() {
	        $('#option_add').append(
					...
					+'<input type="radio" name="optionNameList['+ optionIndex +'].useStock" id="userStock'+ optionIndex +'" class="custom-control-input" value="true">'
					+'<label class="custom-control-label" for="userStock'+ optionIndex +'">재고사용</label> </div>' 
					+'<div class="custom-control custom-radio">' 
					+'<input type="radio" name="optionNameList['+ optionIndex +'].useStock" id="userStock'+ (optionIndex+1) +'" class="custom-control-input" value="false">' 
					+'<label class="custom-control-label" for="userStock'+ (optionIndex+1) +'">재고사용안함</label> </div>' 
					+'</div>' 
